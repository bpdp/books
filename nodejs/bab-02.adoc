...
Perintah untuk memberi masukan di Node.js sudah tersedia pada pustaka API _Readline_footnote:[Lengkapnya bisa diakses di http://nodejs.org/api/readline.html]. Pola dari masukan ini adalah sebagai berikut:
